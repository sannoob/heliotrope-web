...
import { Button, Flex, Spacer, Menu, IconButton, Text, useColorMode } from '@chakra-ui/react';
...
function Header() {
  ...
  return (
    <Flex bg="blackAlpha.100" w="100%" p={4}>
      ...
      <Spacer />
      <IconButton onClick={toggleColorMode} mr={1} aria-label={colorMode==='dark' ? "Enable Light mode" : "Enable Dark mode"}>{colorMode ==='light' ? <MoonIcon /> : <SunIcon />}</IconButton>
